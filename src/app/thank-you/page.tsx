      ...
      <div className="max-w-md w-full text-center space-y-6">
        <div className="space-y-4">
          ...
          <p className="text-stone-300 text-lg">
            ...
            <span className="font-gambarino text-amber-500">amber</span>{" "}
            waitlist. We&apos;ll notify you as soon as we launch.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a
              href="https://instagram.com/ambermoney_co"
              target="_blank"
              rel="noopener noreferrer"
              className="text-stone-400 hover:text-amber-500 transition-colors"
            >
            ...
            <a
              href="https://tiktok.com/@ambermoney_co"
              target="_blank"
              rel="noopener noreferrer"
              className="text-stone-400 hover:text-amber-500 transition-colors"
            >
        ...
        <Button
          variant="outline"
          className="w-full border-stone-700 text-stone-300 hover:bg-stone-800 hover:text-stone-50 cursor-pointer"
          asChild
        >
