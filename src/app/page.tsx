      ...
      <div className="absolute inset-0 bg-gradient-radial"></div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full max-w-7xl mx-auto">
            ...
            <div className="space-y-6 md:space-y-8 text-center lg:text-left">
              {/* Brand */}
              <div className="text-4xl md:text-5xl font-normal text-[#FEB204]" style={{ fontFamily: 'Gambarino, serif' }}>
                amber
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-lg md:text-xl text-[#A69B93] leading-relaxed font-sans font-normal max-w-lg mx-auto lg:mx-0">
                  Never ask &quot;Sorry, what were you guys talking about?&quot; ever again 👀
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex flex-col sm:flex-row gap-3 md:gap-4 max-w-lg mx-auto lg:mx-0" suppressHydrationWarning>
                  ...
                  <button 
                    type="submit"
                    disabled={isSubmitting}
                    className="bg-[#FEB204] hover:bg-[#FEB204]/90 text-[#1C1917] font-sans font-medium px-6 md:px-8 py-2.5 md:py-3 rounded-lg whitespace-nowrap transition-all duration-200 shadow-lg hover:shadow-xl text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                  >
